...
```Python
python passutils.py permutate "one two three four five six seven eight nine ten" --key="test"
...
```Python
python passutils.py permutate "one four ten five eight three six seven two nine" --key="test"
